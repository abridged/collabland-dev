...
- [SmartTag](./key-features/smarttag) - Send, receive, withdraw tokens, and more - fully onchain, right inside your community. Just tag a username. Smart addresses + Discord login = simple, secure, seamless.
