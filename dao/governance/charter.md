...
- 1.1.1 Collab.Land DAO’s mission is to bring communities together through incentive  alignment and shared values with an abundance mindset to create a positive sum  world. 
...
- 5.1.1. Delegates are DAO Members who have been delegated voting power from another party’s governance tokens through an on-chain transaction. Delegation is otherwise known as proxy voting. 
- 5.1.2. Only DAO Members in good standing may be Delegates. 
- 5.1.3. Non-Members who hold the DAO’s governance token may only delegate  their token votes to a DAO Member in good standing. Tokens that have been delegated by non-members will not count towards quorum. 
...
### 8.1. **Taxes**: Members acknowledge and consent that they are responsible for reporting those patronage dividends on their personal tax returns and for paying any tax liability on those patronage dividends. This responsibility includes amounts allocated to a member’s Member Account but not paid out in cash. 
...
### 9.1. Order of distribution of assets in the event of dissolution, liquidation, or sale of all (or substantially all) of the DAO’s assets: 
...
- #### **Rights**. As a legal Member, you have governance and financial rights in the DAO. 
...
### 5. **INDEMNIFICATION**. The Member will protect the DAO from any legal claims, losses,  damages, or expenses that may come up because of the Member not following their responsibilities  outlined in this agreement. This includes all costs and fees for lawyers. The Member is responsible  for their employees, officers, agents, and any other business guests. The Member promises to  protect the DAO from any legal claims or damages that may happen because of the Member or their employees, officers, agents, or business guests. This includes claims for injury or death, even if someone else is also at fault. 
