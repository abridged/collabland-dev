...
/* make dynamic import calls */
//const remarkMath = require('remark-math');
//const rehypeKatex = require('rehype-katex');

let remarkMath, rehypeKatex;

async function loadPlugins() {
  remarkMath = await Promise.resolve(require('remark-math'));
  rehypeKatex = await Promise.resolve(require('rehype-katex'));
}
