---
id: test-qa-bot
title: Run hello-action with Collab.Land QA bot
sidebar_position: 1
---
...
5. To test the project, you can run the following command:

```bash
npm test
```

6. To try out the project, run the `hello-action` server using the following command:
...
To run the `hello-action` test client, open a new terminal tab and use the following command:
